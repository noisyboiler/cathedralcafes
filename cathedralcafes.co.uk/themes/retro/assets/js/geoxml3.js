/****************************************************
  Customised!!! Don't swap out with latest geoXML3
  without checking custom attributes taken from the KML!
  *******************************************************/
    ...
    if (!responseXML) {
      ...
      for (i = 0; i < placemarkNodes.length; i++) {
        ...
        placemark = {
          ...
          //  custom attributes
          id: geoXML3.nodeValue(node.getElementsByTagName('id')[0]),
          url: geoXML3.nodeValue(node.getElementsByTagName('url')[0]),
          tweet:  geoXML3.nodeValue(node.getElementsByTagName('tweet')[0])
        };
...
geoXML3.fetchXML = function (url, callback) {
  ...
  if (!!geoXML3.fetchers.length) {
    ...
    if (!!window.XMLHttpRequest) {
      xhrFetcher = new XMLHttpRequest(); // Most browsers
